  ...
  methods: {
    ...
    summernoteInit: function summernoteInit() {
      ...
      $(document).ready(function () {
        ...
        $('#repeatableSummernote').summernote('code', '');
      });
    }
  },
